...
<div>
    <div class="flex flex-wrap items-center justify-between gap-3 mb-6">
        ...
        <div class="flex items-center gap-2">
            ...
            <a href="{{ url('/kiosk/queue-display') }}" target="_blank" class="btn-secondary">📺 Display Board</a>
        ...
        @forelse($doctorQueue as $docName => $appts)
            <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                <div class="px-4 py-2.5 bg-slate-50 border-b border-slate-200 flex items-center justify-between">
                    <h4 class="text-sm font-semibold text-slate-700">{{ $docName }}</h4>
    ...
    {{-- Lab queue --}}
    <h3 class="text-sm font-bold uppercase tracking-wider text-slate-400 mb-3">Lab Queue <span class="text-slate-300">({{ $labQueue->count() }})</span></h3>
    <div class="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
        <div class="divide-y divide-slate-100">
