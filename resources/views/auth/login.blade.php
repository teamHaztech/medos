...
<div x-data="{ email: '{{ old('email') }}', password: '' }">
    ...
    <div class="mt-6 pt-5 border-t border-slate-200">
        ...
        <div class="space-y-2">
            ...
            <button @click="email='meera.nair@city-care.medos.local'; password='password123'; $nextTick(() => $el.closest('div').previousElementSibling.querySelector('form').submit())"
                class="w-full flex items-center gap-3 px-3 py-2.5 bg-slate-50 hover:bg-blue-50 border border-slate-200 hover:border-blue-300 rounded-lg transition-all text-left">
                <div class="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-bold">M</div>
                <div>
                    <p class="text-sm font-semibold text-slate-800">Dr. Meera Nair</p>
                    <p class="text-xs text-slate-500">meera.nair@city-care.medos.local</p>
                </div>
                <span class="ml-auto px-2 py-0.5 bg-blue-100 text-blue-700 text-xs font-medium rounded">General Medicine</span>
            </button>

            <button @click="email='arjun.das@city-care.medos.local'; password='password123'; $nextTick(() => $el.closest('div').previousElementSibling.querySelector('form').submit())"
                ...
                <div class="w-8 h-8 bg-cyan-600 text-white rounded-full flex items-center justify-center text-xs font-bold">A</div>
                <div>
                    <p class="text-sm font-semibold text-slate-800">Dr. Arjun Das</p>
                    <p class="text-xs text-slate-500">arjun.das@city-care.medos.local</p>
                </div>
            ...
            <button @click="email='eye@haztech.in'; password='password123'; $nextTick(() => $el.closest('div').previousElementSibling.querySelector('form').submit())"
                class="w-full flex items-center gap-3 px-3 py-2.5 bg-slate-50 hover:bg-blue-50 border border-slate-200 hover:border-blue-300 rounded-lg transition-all text-left">
                <div class="w-8 h-8 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-bold">Ey</div>
                <div>
                    <p class="text-sm font-semibold text-slate-800">Dr. Sanjay Rao</p>
                    <p class="text-xs text-slate-500">eye@haztech.in</p>
                </div>
                <span class="ml-auto px-2 py-0.5 bg-blue-100 text-blue-700 text-xs font-medium rounded">Ophthalmology</span>
            </button>
