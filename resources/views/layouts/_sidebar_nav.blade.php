@php
    ...
    $isAdmin = in_array($role, ['super_admin', 'hospital_admin']);
...
{{-- Doctor links (all doctors see these) --}}
...
<div class="pt-4 mt-4 border-t border-slate-700">
    <span class="px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Admin</span>
</div>
...
<div class="pt-4 mt-4 border-t border-slate-700">
    <span class="px-4 text-xs font-semibold text-slate-500 uppercase tracking-wider">Management</span>
</div>
...
<a href="{{ route('web.billing.index') }}" class="sidebar-link {{ request()->routeIs('web.billing.*') ? 'active' : '' }}">
...
<a href="/chat" target="_blank" class="sidebar-link">
